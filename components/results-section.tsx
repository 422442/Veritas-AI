        ...
        <Card className="border-border/50 overflow-hidden shadow-lg">
          <CardContent className="p-0">
            <div className={`p-6 text-center ${getVerdictColor(results.verdict)}`}>
              ...
              <div className="grid grid-cols-3 gap-2 md:gap-4 pt-3 border-t border-current/20">
        ...
        <Card className="border-border/50">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-3">
              ...
              <Progress value={(claimStats.verified / claimStats.total) * 100} className="h-2" />
              ...
              <Progress value={(claimStats.contradicted / claimStats.total) * 100} className="h-2" />
              ...
              <Progress value={(claimStats.unverified / claimStats.total) * 100} className="h-2" />
            </div>
          </CardContent>
        </Card>
